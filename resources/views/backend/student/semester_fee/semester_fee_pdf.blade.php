...
@php 
$registrationfee = App\Models\fee_category_amount::where('fee_category_id','2')->where('course_id',$details->course_id)->first();
...
<table id="customers">
  ...
  <tr>
    ...
    <tr>
    <td>9</td>
    <td><b>Fee For this Student of {{ $semester }} </b></td>
    <td>Ksh. {{ $finalfee }}</td>
  </tr>
