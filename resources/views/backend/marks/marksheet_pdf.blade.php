                        ...
                        <div class="box-body" style="border: solid 1px; padding: 10px;">
                            ...
                            <div class="row"> <!-- start 1st row -->
                                <div style="float: right" class="col-md-2 text-center">
                                    <img src="{{ url('upload/waterfall_institute_logo.png') }}" style="width: 120px; height: 100px;">
                                </div>
                                ...
                                <div class="col-md-4 text-center" style="float: left;">
                                    <h4><strong>Waterfall Institute</strong></h4>
                                    <h6><strong>Kenya</strong></h6>
                            ...
                            <div class="row"> <!-- start 2nd row -->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="8" cellspacing="2">
                                        @php
                                        $assign_student = App\Models\assign_student::where('year_id',$allMarks['0']->year_id)->where('course_id',$allMarks['0']->course_id)->first();
                                        @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%">{{ $allMarks['0']['student_course']['name'] }}</td>
                                        </tr>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="1" cellspacing="1">
                                        ...
                                        <tbody>
                                            ...
                                            $total_unit = App\Models\student_marks::where('year_id',$mark->year_id)->where('course_id',$mark->course_id)->where('exam_type_id',$mark->exam_type_id)->where('student_id',$mark->student_id)->get()->count();
                                            @endphp
                                            <tr>
                                                ...
                                                @php
                                                $grade_marks = App\Models\marks_grade::where([['start_marks','<=', (int)$get_mark],['end_marks', '>=' ,(int)$get_mark ]])->first();
