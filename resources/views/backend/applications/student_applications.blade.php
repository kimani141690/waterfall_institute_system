...
<body>
    ...
    <div class="container">
        ...
        <form action="{{route('student.applications.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <p>
                Dear <span>STUDENT</span> Applicant,<br>
                Welcome to Waterfall Institue.
            ...
            <p>
                <label for="Resultslip">Upload Result Slip</label><br>
                <input type="file" id="Resultslip" name="result_slip"><br>
            </p>
