...
<head>
  <meta charset="utf-8">
    ...
    <title>Waterfall Institute - Registration </title>
            ...
            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" id="name"  name="name" :value="old('name')"  class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Full Name" required autofocus autocomplete="name">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="email" name="email" :value="old('email')" class="form-control pl-15 bg-transparent text-white plc-white"  placeholder="Email" required>
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password" name="password" required autocomplete="new-password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password" required autocomplete="new-password">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
